...
import { Users, Activity, Clipboard, Thermometer, Menu, Bell, LogOut, User } from 'lucide-react';
...
export default function DoctorLayout() {
  ...
  const navItems = [
    { label: 'Queue', icon: Users, path: '/doctor/queue' },
    { label: 'Consultations', icon: Activity, path: '/doctor/consultations' },
    { label: 'Prescriptions', icon: Clipboard, path: '/doctor/prescriptions' },
    { label: 'Lab Requests', icon: Thermometer, path: '/doctor/lab-requests' },
  ];
