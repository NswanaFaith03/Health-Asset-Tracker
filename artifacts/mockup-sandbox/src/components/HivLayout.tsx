...
import { Shield, BookOpen, Menu, Bell, LogOut, User } from 'lucide-react';
...
export default function HivLayout() {
  ...
  const navItems = [
    { label: 'Sessions', icon: Shield, path: '/hiv/sessions' },
    { label: 'Resources', icon: BookOpen, path: '/hiv/resources' },
  ];
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <h1 style={{ color: 'white', fontSize: '1.25rem', fontWeight: '700', margin: 0 }}>
            UNZA DigiHealth - HIV Support Professional
          </h1>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
