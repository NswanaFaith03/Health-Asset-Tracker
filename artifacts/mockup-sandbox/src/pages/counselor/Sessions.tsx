import { useListMentalHealthSessions, useUpdateMentalHealthSession, getListMentalHealthSessionsQueryKey } from '@/lib/api-client';
import { useQueryClient } from '@tanstack/react-query';
import { Heart, MessageSquare, Play, Check } from 'lucide-react';
...
export default function CounselorSessions() {
  ...
  const handleAccept = (id: number) => {
    if (confirm('Accept this counseling session?')) {
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.75rem' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <h3 style={{ color: '#1e293b', fontSize: '1rem', fontWeight: '600', margin: '0 0 0.25rem 0' }}>
                      {session.isAnonymous ? 'Anonymous Student' : session.student?.name ?? 'Student'}
                    </h3>
