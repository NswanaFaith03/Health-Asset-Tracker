...
export default function DoctorConsultations() {
  ...
  const actions = [
    { label: "Queue", icon: "users" as FeatherName, color: "#0d9488", onPress: () => router.push("/(AAron-doctor)/queue") },
    { label: "Prescriptions", icon: "clipboard" as FeatherName, color: "#0369a1", onPress: () => router.push("/(AAron-doctor)/prescriptions") },
    { label: "Lab Requests", icon: "thermometer" as FeatherName, color: "#7c3aed", onPress: () => router.push("/(AAron-doctor)/lab-requests") },
  ];
          ...
          renderItem={({ item }) => {
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => router.push(`/(AAron-doctor)/consultation-detail?id=${(item as any).id}`)}
                activeOpacity={0.75}
              >
