...
import { useEmergency } from "../../features/Faith-emergency/useEmergency";
import { router } from "expo-router";

type FeatherName = React.ComponentProps<typeof Feather>["name"];

const FEATURES: { label: string; icon: FeatherName; route: string; color: string }[] = [
  { label: "New Consultation",  icon: "plus-circle",  route: "/(Faith-student)/new-consultation", color: "#10b981" },
  { label: "Queue",             icon: "users",        route: "/(Faith-student)/queue",            color: "#059669" },
  { label: "Prescriptions",     icon: "clipboard",   route: "/(Faith-student)/prescriptions",    color: "#0891b2" },
  { label: "Lab Results",       icon: "thermometer", route: "/(Faith-student)/lab",              color: "#14b8a6" },
  { label: "Mental Buddy",      icon: "smile",       route: "/(Faith-student)/mental-buddy",     color: "#ec4899" },
  { label: "HIV/AIDS Support",  icon: "shield",      route: "/(Faith-student)/hiv-aids",         color: "#f97316" },
];
        ...
        <View style={styles.headerInner}>
          <View style={styles.headerContentCard}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push("/(Faith-student)/notifications")}
            >
