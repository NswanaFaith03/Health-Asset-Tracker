/**
 * @module Khadijah-Joshua-Pharmacist Portal
 * @file history.tsx
...
export default function PharmacistHistory() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ImageBackground
        source={{ uri: SCREEN_IMAGES.pharmacist.history }}
        style={[styles.heroHeader, { paddingTop: insets.top + 16 }]}
        imageStyle={styles.headerImage}
      >
        <View style={styles.headerOverlay} />
        <Text style={[styles.title, { color: "#000000", position: "relative", zIndex: 1 }]}>Dispensed History</Text>
      </ImageBackground>
      {isLoading ? (
