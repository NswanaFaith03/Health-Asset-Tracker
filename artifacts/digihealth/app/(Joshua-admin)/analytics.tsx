...
export default function AdminAnalytics() {
  ...
  const actions = [
    { label: "Users", icon: "users" as any, color: "#0d9488", onPress: () => router.push("/(Joshua-admin)/users" as any) },
    { label: "Audit", icon: "list" as any, color: "#7c3aed", onPress: () => router.push("/(Joshua-admin)/audit" as any) },
  ];
