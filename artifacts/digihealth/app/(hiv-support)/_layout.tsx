...
export default function HivSupportTabLayout() {
  return (
    <TabLayout 
      allowedRoles={["hiv_professional"]}
      headerRight={<ShiftToggle />}
    >
      <Tabs.Screen name="sessions" options={{ title: "Sessions", tabBarIcon: ({ color }) => <Feather name="shield" size={ICON_SIZE} color={color} /> }} />
      <Tabs.Screen name="resources" options={{ title: "Resources", tabBarIcon: ({ color }) => <Feather name="book-open" size={ICON_SIZE} color={color} /> }} />
