...
export default function StudentTabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="prescriptions" options={{ title: "Rx", tabBarIcon: ({ color, size }) => <Feather name="clipboard" size={size} color={color} /> }} />
      <Tabs.Screen name="lab" options={{ title: "Lab", tabBarIcon: ({ color, size }) => <Feather name="thermometer" size={size} color={color} /> }} />
